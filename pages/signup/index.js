export default function signup({ }) {
    ...
    return (
        ...
        <div class="w-full max-w-md space-y-8">
            <div>
            <img class="mx-auto h-16 w-auto" src="https://www.freeiconspng.com/uploads/red-sports-car-png-1.png" alt="Your Company"/>
            ...
            <div class="-space-y-px rounded-md shadow-sm">
                <div>
                <label for="email-address" class="sr-only px-2">Email address</label>
