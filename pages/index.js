export default function Home() {
  return (
    <div>
      <h1 className="text-2xl text-center font-bold">ADM Car Rentals India Pvt. Ltd.</h1>
      <h3 className="text-2lg text-center my-6 font-bold">From the No.1 Best Car Dealers in India</h3>
      <p className="mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed nec vehicula augue. In blandit justo ex, 
        ...
        Nullam pellentesque sodales venenatis. Mauris semper ex orci, sed sollicitudin purus sodales vitae. 
        Pellentesque consectetur dolor vel mauris posuere efficitur. Duis in orci enim. Vivamus et efficitur 
